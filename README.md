...
server that lets Claude, ChatGPT and Mistral Vibe answer questions about
your training:
...
| Works with | claude.ai, ChatGPT, Mistral Vibe, Claude Desktop, Claude Code | Claude Desktop, Claude Code | everything |
...
it works with **claude.ai in the browser, with ChatGPT and with Mistral
Vibe** - route 2 cannot, because none of those can start a program on your
computer.
...
| [Install for Mistral Vibe](docs/install-mistral.md) | Custom MCP connector, OAuth, troubleshooting |
